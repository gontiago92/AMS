<h1>Editar <small class="label warning">Postado : <?= App::timeago($post->created_at, "pt") ?></small></h1>
<form class="edit-form" method="post" onsubmit="return getContent()">
    ...
    <div class="form-group">
        <textarea name="introduction" id="introduction" cols="30" rows="5"><?= $post->introduction ?></textarea>
    </div>
    ...
    <div class="form-group">
        <button type="submit" class="btn default">Atualizar <i class="fa fa-pen"></i></button>
        <a class="btn danger" href="/post/delete/<?= $article_id ?>">Apagar post <i class="fa fa-trash"></i></a>
    </div>
